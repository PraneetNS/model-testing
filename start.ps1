...
$backendCmd = @"
cd '$Backend'; .\venv\Scripts\Activate.ps1; python -m uvicorn app.main:app --host 127.0.0.1 --port 8000 --reload
"@
...
$celeryCmd = @"
cd '$Backend'; .\venv\Scripts\Activate.ps1; celery -A app.core.celery_app worker --loglevel=info --pool=solo
"@
