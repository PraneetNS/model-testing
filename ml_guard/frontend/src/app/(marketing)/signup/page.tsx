      ...
      >
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            {[
              'Behavioral contract enforcement in < 45ms',
              'Cryptographic PDF certificates (SHA-256)',
              'CI/CD gate — bad models never ship',
            ].map((item) => (
              <li key={item} className="flex items-start gap-2 text-[13px]" style={{ color: '#888884' }}>
        ...
        <div className="w-full max-w-[400px]">
          ...
          <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="first-name" className="block text-[12px] font-medium text-ink-soft mb-1.5">
                  First name
                </label>
                <input
                  id="first-name"
              ...
              <div>
                <label htmlFor="last-name" className="block text-[12px] font-medium text-ink-soft mb-1.5">
                  Last name
                </label>
                <input
                  id="last-name"
            ...
            <div>
              <label htmlFor="new-password" className="block text-[12px] font-medium text-ink-soft mb-1.5">
                Password
              </label>
              <input
                id="new-password"
