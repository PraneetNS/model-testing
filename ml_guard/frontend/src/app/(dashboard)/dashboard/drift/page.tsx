...
export const metadata: Metadata = { title: 'Drift Monitor — Niyantrana Dashboard' };
export default function DriftPage() { return <DashboardPlaceholder title="Drift Monitor" path="Drift" />; }
